...
import OOP_Seminar2.core.clients.supports.Record;
...
public abstract class Animal {
    ...
    public String toString() {
        return CLASS_NAME + ", id=" + id + ", name=" + name + ", numberOfLimbs=" + numberOfLimbs
                + ", registrationDate=" + registrationDate + ", owner=" + owner + ", records=" + records + "]";
    }
